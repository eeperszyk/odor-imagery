...
% Train on imagine, test on imagine
...
for subject = [1681 2020 2129 2162 2306 2369 2397 2435 2438 2455 2457 2459 2460 2461 2463 2464 2467 2468 2472 2476 2477 2479 2480 2481 2482 2483 2484 2485 2487 2488 2489 2490 2491 2492 2497 2498 2499 2502 2503 2507 2508 2509 2510 2518 2526 2528 2533]; % update subject IDs here
	...
	output_dir_SS = [result_path 'ROI_mvpa/6thr_Lpir/' analtype '/rose_cookie/1st/' scaletype '/' sub '/scan1/trainI_testI/'];
	decoding_example_scaled_ROI('roi','imagine rose','imagine cookie',beta_dir,output_dir_SS,4,cfg); % voxel size shouldn't matter because we aren't doing searchlight
